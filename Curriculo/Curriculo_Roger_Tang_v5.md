...
💼 [LinkedIn](https://www.linkedin.com/in/engenheirorogertang) | 🎓 [Currículo Lattes](http://lattes.cnpq.br/7809924946338237)
...
#### **Banco UBS** | Senior Full Stack Developer / Requirements Analyst — (11/2025 – 05/2026)
*   **Modernização de Arquitetura:** Liderança técnica na migração do sistema crítico "Funds Control", transicionando de um legado Windows Forms para uma arquitetura moderna de **APIs REST em C#**.
*   **Otimização com IA:** Implementação de fluxos de desenvolvimento utilizando **GitHub Copilot**, resultando em aumento mensurável na velocidade de entrega e qualidade de cobertura de testes.
*   **Stack:** C#, .NET, SQL Server, Oracle.

#### **XP Investimentos** | Senior Software Specialist — (07/2024 – 03/2025)
*   **Sistemas de Alta Criticidade:** Desenvolvimento Full Stack na unidade de **Renda Fixa**, atuando em ambiente regulado com foco em resiliência e baixa latência.
...
#### **Ingenico / Gertec** | Senior Embedded Software Developer — (2016 – 2020)
...
### **Competências Técnicas Selecionadas**

*   **Linguagens:** C#, C/C++, Go Lang, Python, Java, SQL, ECL.
*   **Arquitetura:** Microserviços, SOA, Design Patterns (MVC, SOLID), Mensageria (RabbitMQ), Docker.
